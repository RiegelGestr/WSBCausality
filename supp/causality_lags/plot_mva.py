...
centrimeters = 1/2.54
with open("../../main/data/mva_GME_with_twitter.csv") as inpuf:
...
ax.plot(ldf["date"],ldf["coeff_volume"],color = color_market,lw = 30,label = "Trading V.",ls = "dotted")
#
...
fig.savefig("fig/fig_2b_lag_7.pdf")
